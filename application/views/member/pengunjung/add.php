    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url('admin/pengguna/daftar') ?>">Kategori</a>
                </li>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/pengunjung/doAdd'?>" role="form"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nama Pengunjung</label>
                            <div class="col-sm-6">
                                <input type="text" id="form-field-1" name="nama" value="" placeholder="Isi Nama Pengunjung" class="form-control" required/>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="form-field-1" name="no_telp" value="" placeholder="Isi No Telp" class="form-control" required/>
                            </div>
                        </div>
