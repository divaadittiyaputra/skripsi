    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url('admin/pengunjung/doUpdate/').$this->uri->segment(4); ?>" role="form"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="nama" value="<?= $detailData->nama_pelanggan?>" placeholder="Isi Nama Pemilik" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="no_telp" value="<?= $detailData->no_telp?>" placeholder="Isi No Telp" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="alamat" value="<?= $detailData->alamat?>" placeholder="Isi Alamat" class="col-xs-10 col-sm-5" required />
                            </div>
                        </div>
