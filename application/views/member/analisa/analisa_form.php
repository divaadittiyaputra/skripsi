<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
            	<form method="post" action="<?= base_url('/admin/analisis/doAnalisa_new/'); ?>">
	                <div class="col-xs-12">
	                	 
	                    <div class="form-group row">
							<div class="col-md-3">
								<select class="form-control selectpicker" name="dari" data-live-search="true" required="">	
									<option value="">Pilih Dari</option>
									<?php 
									$result = $this->db->query("select * from umkm order by nama_umkm asc")->result();
							...
							<div class="col-md-3">
								<select class="form-control selectpicker" name="tujuan" data-live-search="true" required="">	
