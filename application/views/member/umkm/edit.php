<div class="main-content">
    <div class="main-content-inner">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url('admin/umkm/doUpdate/').$this->uri->segment(4); ?>" role="form"> 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="pemilik">
									<?php foreach($pemilik as $value){ ?>
										<option value="<?php echo $value->id_pemilik ?>"  <?php if($value->id_pemilik == $detailData->id_pemilik){ echo "SELECTED"; } ?> ><?php echo $value->nama; ?></option>
									<?php } ?>
                                </select>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="form-field-1" name="no_telp" value="<?= $detailData->telepon?>" placeholder="Isi Nama Produk" class="form-control" required/>
                            </div>
                        </div>
      ...
      <!--                      <div class="col-sm-6">-->
      <!--                          <input type="text" id="form-field-1" name="kecamatan" value="<?= $detailData->kecamatan?>" placeholder="Isi Nama Produk" class="form-control" required/>-->
      <!--                      </div>-->
      <!--                  </div>-->
       ...
       <div class="form-group">
                            ...
                            <div class="col-sm-6">
                               <input type="text" id="form-field-1" name="rt" value="" placeholder="RT" class="form-control" value="<?= $detailData->rt?>" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">RW</label>
                            <div class="col-sm-6">
                               <input type="text" id="form-field-1" name="rw" value="" placeholder="RW" class="form-control" value="<?= $detailData->rw?>" required/>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <select class="form-control select-picker" name="id_kecamatan" id="id_kecamatan" onchange="desa()">
									...
									foreach($result->result() as $value){ ?>
										<option value="<?php echo $value->id_kecamatan ?>" <?php if($value->id_kecamatan == $detailData->id_kecamatan){ echo "SELECTED"; } ?>><?php echo $value->nama_kecamatan; ?></option>
									<?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control select-picker" name="id_desa" id="list_desa">
									...
									foreach($result->result() as $value){ ?>
										<option value="<?php echo $value->id_desa ?>"  <?php if($value->id_desa == $detailData->id_desa){ echo "SELECTED"; } ?>><?php echo $value->nama_desa; ?></option>
									<?php } ?>
                                </select>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="form-field-1" name="ket" value="<?= $detailData->keterangan?>" placeholder="Isi Nama Produk" class="form-control" required/>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="form-field-1" name="legalitas" value="<?php echo $detailData->legalitas ?>" placeholder="Isi Legalitas" class="form-control" />
                            </div>
                        </div>
						<div class="form-group row ">
	                        ...
	                        <div class="col-sm-6">
	                            ...
	                            <input class="postcode form-control" id="Postcode" name="Postcode" type="text" value="<?= $detailData->alamat?>" placeholder="Cari Alamat">
	                        </div>
	                        <div class="col-md-1">
	                            <button class="btn btn-sm" type="button" id="findbutton">Cari</button>
	                        </div>
	                        <div class="col-md-2 col-sm-1">
	                            <input type="hidden" class="form-control" id="latitude" name="lat" placeholder="latitude" value="<?= $detailData->lat ?>" readonly="">
	                        </div>
	                        <div class="col-md-2 col-sm-1">
	                            <input type="hidden" class="form-control" id="longitude" name="lng" placeholder="longitude" value="<?= $detailData->long?>" readonly="">
	                        </div>
	                    </div>
...
function okmap(){
    ...
    function initialize() {
        ...
        var latitude = "<?= $detailData->lat; ?>";
        var longitude = "<?= $detailData->long; ?>";
        var zoom = 17;
		...
		marker = new google.maps.Marker({
            position: LatLng,
            map: map,
            title: "<?= $detailData->nama_umkm.' , '.$detailData->alamat ?>",
            label:"A",
            draggable: false
        });
