                                ...
                                <tbody>
                                 ...
                                 foreach($listData as $value){
                                    ...
                                    <tr>
                                        ...
                                        <td>
											<a href="<?php echo base_url('admin/umkm/detailProduk/'.$value->id_umkm) ?>"><button class="btn btn-success btn-sm btnEmptySaldo"   style="margin-left:2px"><i class="fa fa-pencil-square" style="font-size: 14px;"></i>&nbsp;&nbsp;<span>Detail Produk</span></button></a>
											<!--
