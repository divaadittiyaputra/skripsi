...
--> 
                                                <!--
                                                    <center>
                                                    <a href="register/register.php" class="width-100 btn btn-primary">Daftar</a>
                                                    </center>
                                                    -->
                                                ...
                                                <br><br><br>
                                                    <a href="https://drive.google.com/file/d/1iLSPHAS2sbvp8rP9t0XZhsjwUHut1427/view?usp=sharing"
                                                    <button type="submit" class="width-100 pull-right btn btn-sm btn-primary">
                                                            <i class="ace-icon fa fa-cloud-download"></i>
                                                            <span class="bigger-110">Download Aplikasi</span>
                                                        </button>
                                                    </a>
